    ...
    const html = `
      <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;color:#1a1a1a;">
        <div style="text-align:center;padding:30px 0 20px;">
          <h1 style="color:#ac845d;font-size:24px;margin:0;">Regal Clock</h1>
        ...
        <div style="background:#f8f9fa;border-radius:12px;padding:30px;margin:16px 0;">
          ...
          <p style="color:#555;line-height:1.6;">
            You have been invited to join <strong>${business.name}</strong> as a <strong>${roleLabel}</strong> on Regal Clock.
          </p>
