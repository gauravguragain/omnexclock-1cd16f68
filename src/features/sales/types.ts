...
export const CRM_STAGE_VALUES = ["new", "contacted", "inspection_booked", "inspected", "menu_selected", "invoice_sent", "deposit_received", "runsheet_sent", "full_payment_received", "confirmed", "lost"];
