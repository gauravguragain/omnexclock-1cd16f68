              ...
              <TableBody>
                {groupedEmployees ? (
                  groupedEmployees.map(([groupName, groupEmps]) => (
                    <>{/* Group header: first cell sticky, rest are empty presentational cells */}
                      <TableRow key={`group-${groupName}`} className="bg-muted/40 hover:bg-muted/40 border-border/30">
                        <TableCell className="py-2 px-4 sticky left-0 bg-muted/40 z-20 border-r border-border/60">
