  ...
  return <main className="min-h-dvh bg-background text-foreground">
    ...
    <div className="mx-auto max-w-3xl px-5 py-8">
      ...
      <form onSubmit={submit} className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="space-y-2"><Label htmlFor="eventType">Event type</Label><OptionSelect name="eventType" required defaultValue={eventTypes[0]} options={eventTypes.filter(t => t !== "Other").map(t => ({ value: t, label: t }))} otherPlaceholder="Type your event type" /></div>
